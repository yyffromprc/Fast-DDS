...
eprosima::fastrtps::types::DynamicType_ptr
    DataType<DataTypeKind::TESTING_DATA, GeneratorKind::GEN>::generate_type_() const
{
    // Register using method from Fast DDS Gen autogenerated code
    registerTestingDataTypes();

    auto type_object = GetZeroCopyMessageObject(true);
    auto type_id = GetZeroCopyMessageIdentifier(true);
