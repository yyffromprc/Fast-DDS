...
const char* HelloWorldPublisher::SCHEMA_TEXT_MSG = R"(
uint32 index
string message
)";

const char* HelloWorldPublisher::SCHEMA_TEXT_IDL = R"(
================================================================================
IDL: HelloWorld
struct HelloWorld
{
...
bool HelloWorldPublisher::init()
{
    ...
    // Register a Schema
    helloworld_schema = mcap::Schema(HelloWorldPublisher::SCHEMA_NAME, "ros2idl", HelloWorldPublisher::SCHEMA_TEXT_IDL);
