...
private:
    ...
    void create_type_creator_functions()
    {
        ...
        PUBLISHER_TYPE_CREATOR_FUNCTION(FixMix);
        PUBLISHER_TYPE_CREATOR_FUNCTION(FixId);
        PUBLISHER_TYPE_CREATOR_FUNCTION(FixHexId);
        PUBLISHER_TYPE_CREATOR_FUNCTION(FixHashidDefault);
        PUBLISHER_TYPE_CREATOR_FUNCTION(FixHashid);
        PUBLISHER_TYPE_CREATOR_FUNCTION(DerivedEmptyAutoidSequential);
        PUBLISHER_TYPE_CREATOR_FUNCTION(DerivedAutoidSequential);
        PUBLISHER_TYPE_CREATOR_FUNCTION(DerivedAutoidHash);
        PUBLISHER_TYPE_CREATOR_FUNCTION(DerivedAutoidDefault);
        PUBLISHER_TYPE_CREATOR_FUNCTION(AutoidSequential);
        PUBLISHER_TYPE_CREATOR_FUNCTION(AutoidHash);
        PUBLISHER_TYPE_CREATOR_FUNCTION(AutoidDefault);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringWString);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringWChar);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringUShort);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringULongLong);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringULong);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringString);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringShort);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringOctet);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringLongLong);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringLongDouble);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringLong);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringInnerUnionHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringInnerStructureHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringInnerEnumHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringInnerBitsetHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringInnerBitMaskHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasSequenceHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasMapHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasBoundedWStringHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasBoundedStringHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringInnerAliasArrayHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringFloat);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringDouble);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringChar);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapWStringBoolean);
        ...
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperWString);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperWChar);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperUShort);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperULongLong);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperULong);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperString);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperShort);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperOctet);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperLongLong);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperLongDouble);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperLong);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerUnionHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerStructureHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerEnumHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerBitsetHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerBitMaskHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasSequenceHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasMapHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasBoundedWStringHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasBoundedStringHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperInnerAliasArrayHelper);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperFloat);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperDouble);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperChar);
        PUBLISHER_TYPE_CREATOR_FUNCTION(MapInnerAliasBoundedWStringHelperBoolean);
        ...
        PUBLISHER_TYPE_CREATOR_FUNCTION(wchar_external);
        types_without_typeobject_.insert("wchar_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(ushort_external);
        types_without_typeobject_.insert("ushort_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(ulonglong_external);
        types_without_typeobject_.insert("ulonglong_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(ulong_external);
        types_without_typeobject_.insert("ulong_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(struct_external_optional);
        types_without_typeobject_.insert("struct_external_optional");
        PUBLISHER_TYPE_CREATOR_FUNCTION(struct_external);
        types_without_typeobject_.insert("struct_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(string_unbounded_external);
        types_without_typeobject_.insert("string_unbounded_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(string_bounded_external);
        types_without_typeobject_.insert("string_bounded_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(short_external);
        ...
        PUBLISHER_TYPE_CREATOR_FUNCTION(recursive_union_container);
        types_without_typeobject_.insert("recursive_union_container");
        PUBLISHER_TYPE_CREATOR_FUNCTION(recursive_test_2);
        types_without_typeobject_.insert("recursive_test_2");
        PUBLISHER_TYPE_CREATOR_FUNCTION(recursive_test_1);
        types_without_typeobject_.insert("recursive_test_1");
        PUBLISHER_TYPE_CREATOR_FUNCTION(recursive_structure);
        types_without_typeobject_.insert("recursive_structure");
        PUBLISHER_TYPE_CREATOR_FUNCTION(octet_external);
        types_without_typeobject_.insert("octet_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(map_short_external);
        types_without_typeobject_.insert("map_short_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(longlong_external);
        types_without_typeobject_.insert("longlong_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(longdouble_external);
        types_without_typeobject_.insert("longdouble_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(long_external);
        types_without_typeobject_.insert("long_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(float_external);
        types_without_typeobject_.insert("float_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(ext_struct_external);
        types_without_typeobject_.insert("ext_struct_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(ext_and_inner_struct_external);
        types_without_typeobject_.insert("ext_and_inner_struct_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(double_external);
        types_without_typeobject_.insert("double_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(char_external);
        types_without_typeobject_.insert("char_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(boolean_external);
        types_without_typeobject_.insert("boolean_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(array_short_external);
        types_without_typeobject_.insert("array_short_external");
        PUBLISHER_TYPE_CREATOR_FUNCTION(InnerStructExternal);
        ...
        PUBLISHER_TYPE_CREATOR_FUNCTION(AnnotatedStruct);
